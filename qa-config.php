...
*/
	...
	define('QA_MYSQL_DATABASE', 'q2a-external');
/*	
	======================================================================
	  FOLLOWING ARE THE CREDENTIALS FOR THANKYO DATABASE
	======================================================================
*/

	define('THANKYO_MYSQL_HOSTNAME', 'ec2-52-36-82-77.us-west-2.compute.amazonaws.com');
	define('THANKYO_MYSQL_USERNAME', 'supertest');
	define('THANKYO_MYSQL_PASSWORD', 'supertest');
	define('THANKYO_MYSQL_DATABASE', 'thankyo');

	/*	
	======================================================================
	  URL FOR IMAGES ON S3 - FOR USER'S AVATAR
	======================================================================
*/

	define('THANKYO_AVATAR_LINK', 'http://s3-us-west-2.amazonaws.com/thankyotest/image/');
/*

/*	
	======================================================================
	  URL FOR LOGIN INFO FROM STREAMKAR
	======================================================================
*/

	//define('THANKYO_LOGIN_INFO', 'http://www.tkvivo.com/um/checklogin/');
/*
